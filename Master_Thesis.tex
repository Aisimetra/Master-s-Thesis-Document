...
\begin{titlepage}
 % \thispagestyle{empty}
    ...
    \begin{figure}[b]
      ...
      \subfloat{\includegraphics[height=3.2cm]{img/eth_logo_kurz_pos.png}}
     % \subfloat{\includegraphics[height=2.2cm]{img/sms.pdf}}
  \end{figure}
  \begin{figure}[!b]
        
   %\subfloat{\includegraphics[height=2.2cm]{img/eth_logo_kurz_pos.png}}
    \subfloat{\includegraphics[height=2.2cm]{img/sms.pdf}}
\end{figure}
\end{titlepage}
